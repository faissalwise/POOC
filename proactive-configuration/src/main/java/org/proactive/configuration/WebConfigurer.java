...
import org.proactive.filter.CachingHttpHeadersFilter;
...
public class WebConfigurer implements ServletContextInitializer, WebServerFactoryCustomizer {
    ...
    public WebConfigurer(Environment env, ProActiveProperties proActiveProperties) {
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        if (env.acceptsProfiles(ProActiveConstants.PROFILE_PRODUCTION)) {
            initCachingHttpHeadersFilter(servletContext, disps);
        }
        if (env.acceptsProfiles(ProActiveConstants.PROFILE_DEVELOPMENT)) {
    ...
    public void customize(WebServerFactory server) {
         ...
         */
        if (proActiveProperties.getHttp().getVersion().equals(ProActiveProperties.Http.Version.V_2_0)
    ...
    private void initCachingHttpHeadersFilter(ServletContext servletContext, EnumSet<DispatcherType> disps) {
        ...
        FilterRegistration.Dynamic cachingHttpHeadersFilter = servletContext.addFilter("cachingHttpHeadersFilter",
                new CachingHttpHeadersFilter(proActiveProperties));
    ...
    public CorsFilter corsFilter() {
        ...
        CorsConfiguration config = proActiveProperties.getCors();
