...
public class CachingHttpHeadersFilter implements Filter {
    ...
    private ProActiveProperties proActiveProperties;

    public CachingHttpHeadersFilter(ProActiveProperties proActiveProperties) {
        this.proActiveProperties = proActiveProperties;
    }

    @Override
    public void init(FilterConfig filterConfig) throws ServletException {
        cacheTimeToLive = TimeUnit.DAYS.toMillis(proActiveProperties.getHttp().getCache().getTimeToLiveInDays());
    }
